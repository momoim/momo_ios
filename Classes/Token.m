...
-(void)reset {
    ...
    [MMGlobalData removePreferenceforKey:@"access_token"];
    [MMGlobalData removePreferenceforKey:@"refresh_token"];
    [MMGlobalData removePreferenceforKey:@"phone_number"];
    [MMGlobalData removePreferenceforKey:@"token_expire"];
    [MMGlobalData removePreferenceforKey:@"token_uid"];
    [MMGlobalData savePreference];
}
